...
def main():
    ...
    tb = 5e3
    taps_bh = filter.firdes.high_pass_2(1, fs,
                                        bw, tb, 80,
                                        filter.firdes.WIN_BLACKMAN_hARRIS)
    taps_ham = filter.firdes.high_pass_2(1, fs,
                                         bw, tb, 80,
                                         filter.firdes.WIN_HAMMING)
    taps_hann = filter.firdes.high_pass_2(1, fs,
                                          bw, tb, 80,
    ...
    sp0.set_title("firdes.high_pass_2(gain, fs, bw, tb, atten, window)",
