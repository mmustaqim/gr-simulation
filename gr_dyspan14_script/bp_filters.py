...
def main():
    ...
    fh = 20e3
    tb = 2.5e3
    taps_bh = filter.firdes.band_pass_2(1, fs,
                                        fl, fh, tb, 80,
                                        filter.firdes.WIN_BLACKMAN_hARRIS)
    taps_ham = filter.firdes.band_pass_2(1, fs,
                                         fl, fh, tb, 80,
                                         filter.firdes.WIN_HAMMING)
    taps_hann = filter.firdes.band_pass_2(1, fs,
                                          fl, fh, tb, 80,
    ...
    sp0.set_title("firdes.band_pass_2(gain, fs, f_low, f_hi, tb, atten, window)",
