...
# Title: Demo Ip3
# Generated: Fri Aug 22 08:13:41 2014
##################################################
...
class demo_ip3(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Demo Ip3")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Demo Ip3")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "demo_ip3")
        ...
        self._ip3_layout = Qt.QVBoxLayout()
        self._ip3_tool_bar = Qt.QToolBar(self)
        self._ip3_layout.addWidget(self._ip3_tool_bar)
        self._ip3_tool_bar.addWidget(Qt.QLabel("IP3"+": "))
        class qwt_counter_pyslot(Qwt.QwtCounter):
            def __init__(self, parent=None):
                Qwt.QwtCounter.__init__(self, parent)
            @pyqtSlot('double')
            def setValue(self, value):
                super(Qwt.QwtCounter, self).setValue(value)
        self._ip3_counter = qwt_counter_pyslot()
        self._ip3_counter.setRange(0, 2, 0.01)
        self._ip3_counter.setNumButtons(2)
        self._ip3_counter.setValue(self.ip3)
        self._ip3_tool_bar.addWidget(self._ip3_counter)
        self._ip3_counter.valueChanged.connect(self.set_ip3)
        self._ip3_slider = Qwt.QwtSlider(None, Qt.Qt.Horizontal, Qwt.QwtSlider.BottomScale, Qwt.QwtSlider.BgSlot)
        self._ip3_slider.setRange(0, 2, 0.01)
        self._ip3_slider.setValue(self.ip3)
        self._ip3_slider.setMinimumWidth(200)
        self._ip3_slider.valueChanged.connect(self.set_ip3)
        self._ip3_layout.addWidget(self._ip3_slider)
        self.top_grid_layout.addLayout(self._ip3_layout, 3,1,1,1)
...
# QT sink close method reimplementation
    ...
    def set_ip3(self, ip3):
        self.ip3 = ip3
        Qt.QMetaObject.invokeMethod(self._ip3_counter, "setValue", Qt.Q_ARG("double", self.ip3))
        Qt.QMetaObject.invokeMethod(self._ip3_slider, "setValue", Qt.Q_ARG("double", self.ip3))
